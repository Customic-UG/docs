...
- **Import-Datum** – Kennzeichnen Sie, aus welchem Import-Vorgang ein Lead stammt, z. B. `Import 2024-06`
...
- **Lead-Qualität** – Markieren Sie vielversprechende Leads direkt, z. B. `Hohe Priorität`
...
<AccordionGroup>
  ...
  <Accordion title="Kann ich einen Tag nachträglich entfernen oder ändern?">
    Nein, Tags können nachträglich weder entfernt noch neu erstellt werden. Planen Sie daher schon beim Import, welche Tags Sie verwenden möchten.
  </Accordion>
